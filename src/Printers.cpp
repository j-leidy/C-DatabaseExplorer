...
void warning()
{
	...
	cout << setw(25) << " "
		 ...
		 << "\n";
	cout << setw(25) << " "
		 << "<*PLEASE MAXIMIZE THE CMD WINDOW FOR FORMATTING TO WORK PROPERLY!*>"
		 << "\n";
	cout << setw(25) << " "
		 << "<*                                                               *>"
		 << "\n";
...
void info()
{
	...
	cout << "\n\n\n";
	cout << setw(25) << " "
		 << "=> Creator: John Leidy II\n";
	cout << setw(25) << " "
		 << "=> Version: 1.0\n\n\n";
	cout << setw(25) << " "
		 << "<************************Program Information**********************>\n\n\n";
	cout << setw(25) << " "
		 << "This program uses the c++ sqlite3 wrapper. It allows the user to \n";
	cout << setw(25) << " "
		 << "utilize this wrapper to explore and modify a database of their \n";
	cout << setw(25) << " "
		 << "choice. The user is able to View, Update, Insert and Remove data.\n\n\n";
	cout << setw(25) << " "
		 << "NOTE: Ensure your database is located in the same folder as your\n";
	cout << setw(25) << " "
		 << ".exe application file for this program.\n";
	cout << setw(25) << " "
		 << "NOTE: If using the source code ensure your database is located in\n";
	cout << setw(25) << " "
		 << "the same folder as your source files.\n\n\n";
	cout << setw(25) << " "
		 << "NOTE: You may want to change the font size of your cmd window as\n";
	cout << setw(25) << " "
		 << "well if your database has large entries or a lot of columns in a\n";
	cout << setw(25) << " "
		 << "select table.\n";
	cout << setw(25) << " "
		 << "<*****************************************************************>"
